        ...
        <div style="margin-top: 30px;">
            ...
            <div style="display: flex; gap: 15px; margin-top: 10px;">
                <div style="text-align: center;">
                    <img src="https://hirowallet.gitbook.io/shared/assets/PSX_20230608_110345-9UY8QyNq.png" style="height: 40px; border-radius: 8px;"/>
                    <p style="color: #94a3b8; margin: 5px 0 0; font-size: 0.8rem;">Hiro Wallet</p>
                </div>
                <div style="text-align: center;">
                    <img src="https://pbs.twimg.com/profile_images/1657678377186009089/Ny6k9EAK_400x400.jpg" style="height: 40px; border-radius: 8px;"/>
                    <p style="color: #94a3b8; margin: 5px 0 0; font-size: 0.8rem;">Xverse</p>
                </div>
                <div style="text-align: center;">
                    <img src="https://leather.io/images/logo-icon.png" style="height: 40px; border-radius: 8px;"/>
                    <p style="color: #94a3b8; margin: 5px 0 0; font-size: 0.8rem;">Leather</p>
                </div>
            </div>
        </div>
    </div>
